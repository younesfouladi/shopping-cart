            ...
            <div className="py-4 space-y-4 w-full">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center bg-neutral-200 rounded-full p-1 gap-4">
                  <button className="text-green-600 text-3xl bg-neutral-50 rounded-full w-7 h-7 flex items-center justify-center">
                    -
                  </button>
                  <p className="font-bold text-lg">{item.quanity}</p>
                  <button className="text-neutral-50 text-3xl bg-green-600 rounded-full w-7 h-7 flex items-center justify-center">
                    +
                  </button>
                </div>
              </div>
